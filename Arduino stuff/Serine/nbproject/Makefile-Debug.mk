...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libserine.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libserine.a: ${OBJECTFILES}
...
${OBJECTDIR}/Serine.o: Serine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Serine.o Serine.cpp
